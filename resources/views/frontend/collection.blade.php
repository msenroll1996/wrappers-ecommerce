        ...
        <section class="site__default grid-view uk-padding uk-padding-remove-horizontal" style="padding-top: 0;">
            <div class="uk-container-expand uk-padding uk-padding-remove-vertical">
                <div class="uk-child-width-1-1 uk-child-width-1-2@m uk-child-width-1-4@l" uk-grid>
                    ...
                    <div class=" uk-card-body uk-card uk-position-relative">
                    <a href="{{route('frontend.product.single_product',['slug' => $product->slug])}}" class="uk-card-media-top">
                                <img src="{{url( 'storage/'.$product->image_first )}}" class="uk-border-rounded" alt="">
                                <a href="{{route('frontend.product.single_product',['slug' => $product->slug])}}" class="uk-position-absolute uk-position-top-right uk-text" style="margin-right: 10px; margin-top: 10px;color:black;">View</a>
                            </a>
                    ...
                    <!-- <div>
                        <div class="uk-card uk-position-relative">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title" style="margin-bottom: 10px;"><a href="#" class="uk-text-secondary">{{$product->name}}</a></h3>
                                <span class="uk-text-bold uk-text-secondary">Rs. {{$product->selling_price}}</span>
                            </div>
                ...
                <div class="uk-card uk-card-default uk-padding uk-padding-remove-vertical" style="box-shadow: none;">
                    <div uk-grid>
                        <div class="uk-card-media-left uk-cover-container uk-width-1-1 uk-width-1-5@l">
                            <img src="{{url( 'storage/'.$product->image_first )}}" alt="" uk-cover>
